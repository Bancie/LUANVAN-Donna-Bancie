...
\onslide<1->{Giả sử ta nhận được tập phương án tối ưu của bài toán \eqref{2.4} sau hữu hạn lần giải, ký hiệu $(x_b, y_b)$ và giá trị tối ưu là $z_b$ thì ta có nhận xét sau:}
